export const LOCATIONS = [
  ...
  { id: "654871f43b487c570756c144", name: "Main Street", className: "main-street", color: "#7a4d26", order: 2 },
  ...
  { id: "656bbaac3fe3596cc6aab549", name: "Union Road", className: "union-road", color: "#b95421", order: 5 },
